      ...
      <div class="container-fluid y-side">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto navbar-nav-2">
            ...
            <li class="nav-item">
              <a class="nav-link nav-link-2" href="{{route('all-mock-exams')}}">Mock Exam</a>
            </li>

            <li class="nav-item">
              <a class="nav-link nav-link-2" href="{{route('all-crash-courses')}}">Crash Courses</a>
            </li>
          ...
          <ul class="navbar-nav ml-auto navbar-nav-3 cust">
            <li class="nav-item">
              <a class="nav-link nav-link-2 join-us-now" href="{{route('tutor-login')}}">Login as tutor</a>
            </li>
            <li class="nav-item">
              <a class="nav-link nav-link-2 join-us-now" href="{{route('student-register')}}"> Student</a>
            </li>
            <li class="nav-item">
              <div class="dropdown">
                <button class="btn join-us-now text-white dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false">
                  <img src="assets/images/avatar.jpg" style="border-radius: 50%; width: 30px" alt="">
                </button>

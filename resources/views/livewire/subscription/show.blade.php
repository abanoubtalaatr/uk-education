          ...
          <div class="container">
              <div class="row">
                  <div class="head-path">
                      ...
                      <h3 class="mt-5">All Chapters <button wire:click="bookNow" class="btn btn-info mx-5">Subscribe 
                              now</button></h3>
                      <hr>
                  </div>
              </div>
                  ...
                  <div class="col-md-3 col-sm-12">
                      <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                          ...
                          @foreach ($subscription->topics()->latest()->get() as $index => $topic)
                              <button class="nav-link mb-2 btn btn-join {{ $index == 0 ? 'active' : '' }} {{ $topic->is_paid ? 'locked' : '' }}"
